...
export class SidebarProvider implements vscode.WebviewViewProvider {
  ...
  public async pushState(): Promise<void> {
    ...
    const pendingConflict = this.configurationStore.viewState().conflict ?? await this.pendingConflict();
